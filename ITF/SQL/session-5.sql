...
/*-----------------------------------------------------------------------------------------
 ...
 PRIMARY KEY AUTOINCREMENT kullanılabilir.

 FOREIGN KEY - Başka bir tablodaki Primary Key’i referans göstermek için kullanılır. 
 Böylelikle, tablolar arasında ilişki kurulmuş olur. Forein key tekrarlı olabilir.
...
-- yukarıdaki sorguda name değeri null oldu aşağıdakinde ise default değer olan NONAME oldu.
	
	--name kısmına NONAME yazılır. (DEFAULT)
	INSERT INTO workers (id, id_number, salary) VALUES(4,"57786678910",9000);
  
/*vacation_plan tablosunu place_id sutunu PRIMARY KEY ve employee_id sutununu 
...
Bu tablo, employees tablosu ile ilişkili olmalıdır */ 
 ...
 INSERT INTO vacation_plan2 VALUES(34,"TURKEY", 'HAPPY DEdeman',9,5,5000);
 
 --HATA (FOREIGN KEY constraint failed). referans aldığımız tabloda EmployeeId 9 yok.
...
/*------------------------------------------------------------------------------------------
/*  ALTER TABLE (ADD, RENAME TO, DROP) sütün ekleme silme update etme
...
--- interview de CRUD işlemleri nedir? JOIN işlemleri nedir örneklendirin. 
--- DDL DDM farkı nedir komutları nedir.
